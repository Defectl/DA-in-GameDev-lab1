...
- С помощью Anaconda Promt нужно активировать новый ML-агент и скачать новые библиотеки: mlagents 0.28.0 (в моем случаее я устанавливала на версию ниже), torch 1.7.1. Вводим такие команды:
