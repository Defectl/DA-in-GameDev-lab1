...
Дополняем наш код, чтобы выводились все значения и звуковое сопровождение к ним, теперь он выглядит так:
```py
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
...
Теперь в консоли выводят все данные из google-таблицы и звуковое сопровождение. Для значение больших ста: "Вы самый жестокий тиран в королестве, Ваша Светлость"; для значений в диапозоне от 10 до 100: "Люди доверяют Вам, милорд"; для значений меньше 10: "Люди восхищаются Вами, мой Лорд".
...
Сначала также нужно создать новый проект и подключить необходимые файлы. Затем нужно изменить данные воспроизведения аудио-файлов из 1 задания. Теперь если значение меньше двух, то выходит хорошая аудио-запись, больше двух и меньше трёхсот - нормальная, больше 300 - плохая.
